...
" trailing white space as middle dots
set list
...
" no help when mistype on F1 key
inoremap <F1> <ESC>
nnoremap <F1> <ESC>
vnoremap <F1> <ESC>
...
" save work when auto focus is lost
au FocusLost * :wa
...
nnoremap <leader>p :set foldlevel=0<cr>
nnoremap <leader>o :set foldlevel=99<cr>
let g:vim_json_syntax_conceal = 0
let g:vim_markdown_conceal = 0
let g:vim_markdown_conceal_code_blocks = 0

" remap tap in normal and visual
nnoremap <tab> >>
vnoremap <tab> >
nnoremap <s-tab> <<
vnoremap <s-tab> <
